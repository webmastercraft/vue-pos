<template>
    <div>
        <Breadcrumbs main="Shops" title="Shop Profile"/>
                ...
                <div class="col-sm-12">
                  <div class="card hovercard text-center">
                    ...
                    <div class="user-image">
                      ...
                      <div class="icon-wrapper"><a href="/shops/edit"><i class="icofont icofont-pencil-alt-5"></i></a></div>
                    </div>
                    <div class="info">
                      <div class="row">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="ttl-info text-left">
                                <h6><i class="fa fa-envelope mr-2"></i>Email</h6><span>dailliappShop@yahoo.com</span>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="ttl-info text-left">
                                <h6><i class="fa fa-calendar mr-2"></i>BOD</h6><span>02 January 2022</span>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class="col-sm-12 col-lg-4 order-sm-0 order-xl-1">
                          <div class="user-designation">
                            <div class="title"><a target="_blank" href="">Dailli App Shop</a></div>
                            <div class="desc mt-2">IT Shop</div>
                          </div>
                        </div>
                        <div class="col-sm-6 col-lg-4 order-sm-2 order-xl-2">
                          <div class="row">
                            <div class="col-md-6">
                              <div class="ttl-info text-left">
                                <h6><i class="fa fa-phone mr-2"></i>Contact Us</h6><span>Jordan +91 123-456-7890</span>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="ttl-info text-left">
                    ...
                    <div class="profile-img-style">
                      ...
                      <div class="img-container">
                        <div id="aniimated-thumbnials" itemscope="">
                          <figure class="m-0"><a href="#"><img class="img-fluid rounded" src="../../assets/images/other-images/profile-style-img3.png"></a>
                          </figure>
                        </div>
                      </div>
                ...
                <div class="col-sm-12">
                  <div class="card">
                    <div class="profile-img-style">
                      ...
                      <hr>
                      <p>you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet.</p>
                      <div class="row mt-4 pictures" id="aniimated-thumbnials-2" itemscope="">
                        <figure class="col-sm-6 m-0"><a href="#"><img class="img-fluid rounded" src="../../assets/images/other-images/profile-style-img.png"></a>
                        </figure>
                        <figure class="col-sm-6 m-0"><a href="#"><img class="img-fluid rounded" src="../../assets/images/other-images/profile-style-img.png"></a>
                        </figure>
                      </div>
