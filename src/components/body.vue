    ...
    <div class="page-wrapper" :class="layoutobj">
      ...
      <div class="page-body-wrapper">
        ...
        <div class="sidebar-wrapper" 
          ...
          <!-- <div class="btn-group-vertical shop_btns" role="group" aria-label="Vertical button group">
            <button class="btn btn-success" type="button" data-bs-original-title="" title="">Commercial</button>
            <button class="btn btn-primary" type="button" data-bs-original-title="" title="">Professional</button>
            <button class="btn btn-secondary" type="button" data-bs-original-title="" title="">Medical</button>
            <button class="btn btn-info" type="button" data-bs-original-title="" title="">Industrial</button>
            <button class="btn btn-success" type="button" data-bs-original-title="" title="">Services</button>
            <button class="btn btn-danger" type="button" data-bs-original-title="" title="">Educational</button>
            <button class="btn btn-primary" type="button" data-bs-original-title="" title="">Tourism</button>
            <button class="btn btn-warning" type="button" data-bs-original-title="" title="">Real Estate</button>
          </div> -->
        </div>
