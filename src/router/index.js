...
/* Shop Profile */
import ShopProfile from '../pages/shops/profile';
import ShopEditProfile from '../pages/shops/edit-profile';
import ShopCreat from '../pages/shops/creat';
import ShopCards from '../pages/shops/cards';                                     
...
{ path: '/dashboard', redirect: { name: 'default' } },
{
  path: '/dashboard',
  component: Body,
  meta: {
